...
export default function ProductDetail() {
  ...
  const handleZoom = (event: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
    ...
    // ==> nếu có 1 component mà không thể css cho nó thì nên dùng cách 2
    ...
    // sẽ gặp hiện tượng
    // bubble event : là khi hover (hoặc 1 sự kiện js nào đó) vào element con thì cũng đồng nghĩa đang hover vào element cha.
            ...
            <div className='col-span-5'>
              ...
              >
                <img
                  src={activeImage}
                  alt={product.name}
                  className='absolute left-0 top-0 h-full w-full bg-white object-cover' // nếu dùng cách 2 thì không cần pointer-events-none
                  ref={imageRef}
                />
              </div>
