      ...
      <div className='my-4 h-[1px] bg-gray-300'>
        ...
        <div className='my-5'>
          ...
          <form className='mt-2' onSubmit={onSubmit}>
            ...
            <Button className='80 flex w-full items-center justify-center bg-orange p-2 text-sm uppercase text-white hover:bg-orange'>
              Áp dụng
            </Button>
          </form>
        </div>
        ...
        <div className='my-4 h-[1px] bg-gray-300'>
          <Button
            ...
            className='flex w-full items-center justify-center bg-orange px-2 py-2 text-sm uppercase text-white hover:bg-orange/80'
          >
            Xóa tất cả
          </Button>
        </div>
